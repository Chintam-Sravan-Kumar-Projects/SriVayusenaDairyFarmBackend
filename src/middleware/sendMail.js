...
const sendMail= (req, res,next) => {
   ...
   // console.log("data",req.milkdata);
    const {litter,shift,date,mobile,category}=req.milkdata;
    ...
    const mailOptions = {
      ...
      subject: 'Milk Report Receipt, Sri Vayusena Dairy Farm (Automated - No Replies) sent you a message ',
      //text:`hello ${name}\nMilk Report:\nDate: ${date}\nShift: ${shift}\nCategory: ${category} \nFat: ${fat}\nSNF: ${snf}\nDegree: ${degree}\nWater: ${water}\nTotal: ${litter} Litter`,
      html:`<!DOCTYPE html5>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p class="thank-you">Thank you for buying at Sri Vayusena Dairy Farm</p>
